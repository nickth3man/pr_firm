...
from pr_firm.core.flows import create_pr_flow
...
def main():
    ...
    Initializes the PocketFlow workflow and executes content generation
    for brand-compliant marketing copy across multiple platforms.
    """
...
def launch_gradio():
    """Launch the Gradio web UI for interactive content generation.

    Provides a user-friendly interface for configuring platforms, topics,
    and brand bibles without using the command line.
    """
    if not HAS_GRADIO:
